...
import ast.Program;
import parser.jcc.JCCArithLangParser;
...
public class Parser {
    ...
    private static Program parse(Reader input) throws ParseException {
        JCCArithLangParser parser = new JCCArithLangParser(input);
    ...
    public static Expression parseExp(String exp) throws ParseException {
        JCCArithLangParser parser = new JCCArithLangParser(new StringReader(exp));
