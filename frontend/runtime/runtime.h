/*
 * A minuscule "runtime" environment for arithlang.
 *
...
/* 
 * This function should be created by the arithlang compiler. 
 * It will be called by the runtime to start the arithlang program.
 */
void cs411main();
